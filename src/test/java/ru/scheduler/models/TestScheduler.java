...
public class TestScheduler {
    ...
    public void testWaitingTasks() throws InterruptedException {
        ...
        //Task1
        Assertions.assertEquals(State.WAITING, scheduler.getWaitingTasks().get(Priority.SECOND).peek().getState());
    ...
    public void testFinishedTasks() throws InterruptedException {
        ...
        Task task1 = new Task("task1", TaskType.MAIN, State.READY, Priority.FIRST, 1);
        scheduler.getReadyTasks().get(task1.getPriority()).add(task1);
        Task task2 = new Task("task2", TaskType.EXTENDED, State.READY, Priority.ZERO, 1);
        scheduler.getReadyTasks().get(task2.getPriority()).add(task2);
        Task task3 = new Task("task3", TaskType.MAIN, State.READY, Priority.THIRD, 1);
        scheduler.getReadyTasks().get(task3.getPriority()).add(task3);
        Task task4 = new Task("task4", TaskType.MAIN, State.READY, Priority.FIRST, 1);
        scheduler.getReadyTasks().get(task4.getPriority()).add(task4);
        Task task5 = new Task("task5", TaskType.MAIN, State.READY, Priority.SECOND, 1);
        scheduler.getReadyTasks().get(task5.getPriority()).add(task5);
        Task task6 = new Task("task6", TaskType.EXTENDED, State.READY, Priority.SECOND, 1);
        scheduler.getReadyTasks().get(task6.getPriority()).add(task6);
        Task task7 = new Task("task7", TaskType.MAIN, State.READY, Priority.THIRD, 1);
        scheduler.getReadyTasks().get(task7.getPriority()).add(task7);
        Task task8 = new Task("task8", TaskType.MAIN, State.READY, Priority.ZERO, 1);
        scheduler.getReadyTasks().get(task8.getPriority()).add(task8);
        Task task9 = new Task("task9", TaskType.EXTENDED, State.READY, Priority.ZERO, 1);
        scheduler.getReadyTasks().get(task9.getPriority()).add(task9);
        Task task10 = new Task("task10", TaskType.EXTENDED, State.READY, Priority.SECOND, 1);
