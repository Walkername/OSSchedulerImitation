...
public class TestTask {
    ...
    public void testSettersGetters() {
        Task task = new Task("", TaskType.MAIN, State.SUSPENDED, Priority.FIRST, 5);
    ...
    public void testEqualsAndHash() {
        Task task1 = new Task("", TaskType.MAIN, State.READY, Priority.SECOND, 40);
        Task task2 = new Task("", TaskType.MAIN, State.READY, Priority.SECOND, 40);
    ...
    public void testToString() {
        ...
        task1 = new Task("Yfg", TaskType.MAIN, State.READY, Priority.SECOND, 40);
        task2 = new Task("SAgffg", TaskType.EXTENDED, State.READY, Priority.SECOND, 40);
            ...
            for (State state : State.values()) {
                for (Priority priority : Priority.values()) {
                    for (int i = 1; i < 6; i++) {
                        ...
                        Task createdTask = new Task("", type, state, priority, i);
